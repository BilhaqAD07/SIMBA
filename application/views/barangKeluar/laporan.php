    ...
    <div class="col-lg-12 mb-4" id="container">
        ...
        <div class="card border-bottom-secondary shadow mb-4">
            <div class="card-body">
                ...
                <form action="<?= base_url() ?>laporan/barang_keluar_excel" method="POST" target="_blank">
                    <div class="row">
                        <div class="col-lg-3 mb-4">
                            <div class="input-group">
...
function filter() {
    ...
    if (tglawal != '' && tglakhir != '') {
        filterBk(tglawal, tglakhir, jenisFilter); // Modify this line
    } else {
...
function filter2() {
    ...
    if (tglawal2 != '' && tglakhir2 != '') {
        filterBk(tglawal2, tglakhir2, jenisFilter2); // Modify this line
    } else {
        validasi("Tanggal Filter wajib di isi!", "warning");
    }
}
    ...
    var t = $('#dtHorizontalExample').DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                "render": function(data, type, row) {
                    return (row.jumlah_keluar * row.hargajual).toLocaleString('id-ID', {
                        style: 'currency',
                        currency: 'IDR'
                    });
                }
...
function filterBk(tglawal, tglakhir, jenisFilter) {
    var link = $('#baseurl').val();
    var base_url = link + 'BarangKeluar/filterBarangKeluar/' + tglawal + '/' + tglakhir + '/' + jenisFilter;
